...
class AuthScreen(DarkScreen):
    def __init__(self, **kwargs):
        ...
        # ���� �����
        form = BoxLayout(orientation='vertical', spacing=dp(12), padding=dp(20),
        ...
        form.add_widget(Label(text="Авторизация", font_size=sp(24), bold=True, color=self.conf.text_color,
                              size_hint_y=None, height=dp(40)))

        form.add_widget(Label(text="Логин", size_hint_y=None, height=dp(25), color=self.conf.text_color))
        self.login = StyledTextInput(hint_text="Введите логин", size_hint_y=None, height=dp(45))
        form.add_widget(self.login)

        form.add_widget(Label(text="Пароль", size_hint_y=None, height=dp(25), color=self.conf.text_color))
        self.password = StyledTextInput(password=True, hint_text="Введите пароль", size_hint_y=None, height=dp(45))
...
class RegisterScreen(DarkScreen):
    def __init__(self, **kwargs):
        ...
        # ���� �����
        form = BoxLayout(orientation='vertical', spacing=dp(12), padding=dp(20),
                         size_hint=(0.8, None))  # ������ 80% ����, ������ ��� �������
        form.bind(minimum_height=form.setter('height'))  # ����-���� �� �����������
        anchor.add_widget(form)

        form.add_widget(Label(text="Регистрация", font_size=sp(24), size_hint_y=None, height=dp(40), bold=True, color=self.conf.text_color))
        ...
        form.add_widget(Label(text="ФИО", size_hint_y=None, height=dp(25), color=self.conf.text_color))
        self.fio = StyledTextInput(hint_text="Введите ФИО", size_hint_y=None, height=dp(45))
        form.add_widget(self.fio)

        form.add_widget(Label(text="Телефон", size_hint_y=None, height=dp(25), color=self.conf.text_color))
        self.phone = StyledTextInput(hint_text="Введите телефон", size_hint_y=None, height=dp(45))
        form.add_widget(self.phone)

        form.add_widget(Button(text="Зарегистрироваться", size_hint_y=None, height=dp(45),
                               background_color=self.conf.primary_btn, color=self.conf.text_color,
